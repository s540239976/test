...
<div class="right">
        ...
        <div class="providerAdd">
            <fm:form enctype="multipart/form-data" modelAttribute="user" id="userForm" name="userForm" method="post" action="${pageContext.request.contextPath }/user/addUserSave">
                ...
                <div>
                    ...
                    <fm:input type="text" Class="Wdate" id="birthday" name="birthday" path="birthday"
                ...
                <div>
                    <label >用户角色：</label>
                    <!-- 列出所有的角色分类 -->
					<select name="userRole" id="userRole" path="userRole">
                    </select>
	        		<font color="red"></font>
                </div>

                <div>
                    <label for="address">证件照：</label>
