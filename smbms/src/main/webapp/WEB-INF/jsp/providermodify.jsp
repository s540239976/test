...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
  ...
  <div class="right">
      ...
      <div class="providerAdd">
          <form enctype="multipart/form-data" id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/provider/modifyPorviderSave">
			...
			<font color="red"></font>
              ...
              <c:if test="${not empty provider.idPicPath}">
                  <div>
                      <label>供应商附件：</label>
                      <img style="width: 60px;height: 60px"
                           src="${pageContext.request.contextPath }/statics/upload/${provider.idPicPath}">
                  </div>
              </c:if>
              <c:if test="${empty provider.idPicPath}">
                  <div>
