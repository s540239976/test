...
<div class="right">
	...
	<div class="providerView">
		...
		<p><strong>商品名称：</strong><span id="proName"></span></p>
		<p><strong>商品单位：</strong><span id="proUnit"></span></p>
		<p><strong>商品数量：</strong><span id="proCount"></span></p>
		<p><strong>总金额：</strong><span id="total"></span></p>
		<p><strong>供应商：</strong><span id="provider"></span></p>
		<p><strong>是否付款：</strong><span id="isPay"></span></p>
	</div>
  </div>
</section>
