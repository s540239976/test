...
<div class="right">
        ...
        <div class="providerAdd">
           <fm:form enctype="multipart/form-data" modelAttribute="provider" id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/provider/addProviderSave">
			<input type="hidden" name="method" value="add">
               ...
               <div>
                   <label for="proAddress">组织机构代码证：</label>
                   <input type="file" name="a_workPicPath" id="a_workPicPath"/>
                   <font color="red">${uploadFileError1}</font>
               </div>
