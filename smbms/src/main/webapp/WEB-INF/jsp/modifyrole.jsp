...
<div class="right">
    ...
    <div class="providerAdd">
        <form id="userForm" name="userForm" method="post" action="${pageContext.request.contextPath }/role/modifyRoleSave">
            <!--div的class 为error是验证错误，ok是验证成功-->
            <input type="hidden" name="id" value="${role.id }"/>
            <div>
                <label for="userCode">角色编码：</label>
                <input type="text" name="roleCode" id="roleCode" value="${role.roleCode}" readonly/>
                <!-- 放置提示信息 -->
                <font color="red"></font>
            </div>
            <div>
